...
import { createWorkspace, deleteWorkspace, listWorkspaces, updateWorkspace } from './workspaces.controller.js';
...
workspaceRouter.patch('/:workspaceId', requireAuth, validate(updateWorkspaceSchema), updateWorkspace);
