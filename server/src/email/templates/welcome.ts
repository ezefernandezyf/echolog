export function render(userName: string | null): string {
...
<html lang="en">
  <head>
    ...
    <title>Welcome to EchoLog</title>
  </head>
      ...
      <tr>
        <td style="padding: 0 40px 12px;">
          ...
          <p style="margin: 0 0 16px; font-size: 16px; line-height: 1.6; color: #374151;">
            Thanks for joining EchoLog — the customer feedback platform that helps teams build better products together.
          </p>
          <p style="margin: 0 0 4px; font-size: 16px; line-height: 1.6; color: #374151;">
